...
>***For the convenience of users the assignTaxonomy module from dada2 is given below. However, the users can use the IdTaxa tool for taxonomy assignment and create the phyloseq object but the codes need to be changed***
