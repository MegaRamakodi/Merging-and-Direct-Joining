...
This bioinformatics workflow also could be used to infer prokaryotic and eukaryotic diversity using mixed amplicon sequencing data without splitting the 16S and 18S rRNA reads.
## Prerequisites
